...
//Bootstrap core CSS
Html::loadAssets("gentelella/vendors/css/bootstrap.min.css");
Html::loadAssets("gentelella/vendors/fonts/css/font-awesome.min.css");
Html::loadAssets("gentelella/vendors/css/animate.min.css");

//<!-- Documentation extras -->
Html::loadAssets("gentelella/vendors/css/docs.min.css");
Html::loadAssets("gentelella/vendors/js/jquery.min.js");
Html::loadAssets("gentelella/vendors/js/shCore.js");
Html::loadAssets("gentelella/vendors/js/shBrushXml.js");
Html::loadAssets("gentelella/vendors/css/shCoreDefault.css");
?>
...
<body data-twttr-rendered="true" cz-shortcut-listen="true">
        ...
        <div class="container body">
            ...
            <div class="col-md-12 thumbnail" style="margin-top:30px; margin-bottom: 50px; padding:5px;">
                <img src="<?= Html::getImage("welcome.png") ?>" style="width:100%;" />
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div id="files_and_directories">
                        <div class="content">
                            ...
                            <div class="col-md-6">
                                <img src="<?= Html::getImage("welcome.png") ?>" style="width: 100%; border: 1px solid #ccc; padding:5px;" />
                            </div>
        ...
        <?php 
        Html::loadAssets("gentelella/vendors/js/jquery.min.js");
        Html::loadAssets("gentelella/vendors/js/bootstrap.min.js");
        ?>
